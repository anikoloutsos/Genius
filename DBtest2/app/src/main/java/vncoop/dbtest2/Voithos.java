...
/**
 * Created by Alexandros on 19/4/2015.
 */
public class Voithos extends SQLiteOpenHelper{

    //Ορισμός Χαρακτηριστικών της βάσης\\
    private static String db_path = "/data/data/vncoop.dbtest2/databases/";
    ...
    public Voithos(Context context) {
